...
class GaleriModel(models.Model):
    ...
    def get_absolute_url(self):
        return "/projeler/{pk}/".format(pk=self.pk)
...
class GaleriImage(models.Model):
    ...
    class Meta:
        verbose_name = 'Projeler Resim'
        verbose_name_plural = 'Projeler Resimleri'
...
class GaleriAnasayfaModel(models.Model):
    pagetitle =models.CharField(max_length=500,verbose_name = "ana başlık",null=True,blank=True)
    pagesubtitle =models.CharField(max_length=500,verbose_name = "alt başlık",null=True,blank=True)
    main_image = models.FileField(blank=True ,null=True, verbose_name="Ana Fotoğraf")
   
    
     
    def __str__(self):
        return '%s %s' % (self.pagetitle, 'Projeler')
 
    class Meta:
        ordering = ['id']
        verbose_name = 'Projeler ana sayfa'
        verbose_name_plural = 'Projeler ana sayfa'
